    ...
    for index in range(10):
        ...
        try:
            ...
            # If the user enters the wrong integer answer to the sum, the program will give the user 2 more attempts.
                ...
                count = 1
                while count < 3:
                    answer_again = int(input("Answer: ")) #TODO Martin said this is clunky. 
        ...
        # If the user enters a wrong format answer like "one" instead of "1", this block will be triggered. 
            ...
            while True:
                try:
                    ...
                    print("Sorry. I didn't understand that.") #TODO duplication again
                    print()
                    continue
                else:
                    break
            ...
            if except_block_user_answer == sum_of_two_digits: #TODO 
                correct_answer += 1
                print("Correct.")
                print()
            ...
            # The program will give the user 2 more attempts for correct integer answer before moving to the next question. 
                ...
                count = 1
                while count < 3:
                    answer_again = int(input("Answer: ")) #TODO same code block as above. Redo. 
                    if answer_again == sum_of_two_digits:
                        correct_answer += 1
                        print("Correct!")
                        print()
...
#todo The whole function is double the size of what it can be. But you have to be smart with the loops. 